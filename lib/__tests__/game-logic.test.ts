...
function runTests() {
  ...
  assertEqual(
    getBoardSize("classic3"),
    3,
    "Classic 3x3 board size should be 3"
  );
  ...
  assert(
    isValidPosition("classic3", 0, 0),
    "Position (0,0) should be valid for classic3"
  );
  assert(
    isValidPosition("classic3", 2, 2),
    "Position (2,2) should be valid for classic3"
  );
  assert(
    !isValidPosition("classic3", 3, 0),
    "Position (3,0) should be invalid for classic3"
  );
  assert(
    !isValidPosition("classic3", 0, -1),
    "Position (0,-1) should be invalid for classic3"
  );
  assert(
    isValidPosition("gomoku", 14, 14),
    "Position (14,14) should be valid for gomoku"
  );
  assert(
    !isValidPosition("gomoku", 15, 0),
    "Position (15,0) should be invalid for gomoku"
  );
  ...
  assert(
    !isPositionOccupied(board, 0, 2),
    "Position (0,2) should not be occupied"
  );
  ...
  assert(
    !isPlayerTurn("p1", null, players),
    "No player's turn when currentTurn is null"
  );
