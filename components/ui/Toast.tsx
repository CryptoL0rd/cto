        ...
        {toasts.map((toast) => (
          <div
            ...
            className={cn(
              ...
              toast.type === 'success' && 'bg-cosmic-500/20 border-cosmic-500/50 text-cosmic-200',
              toast.type === 'error' && 'bg-nebula-500/20 border-nebula-500/50 text-nebula-200',
              toast.type === 'info' && 'bg-galaxy-500/20 border-galaxy-500/50 text-galaxy-200'
            )}
            role="alert"
          >
